...
-->
  ...
  <!-- <img
	...
	<div class="footer__disclaimer">
          All content copyright Enchanted Winter Woods |
          Louisville Kentucky's Most Enchanting Winter Attractions © <span id="year"></span> • All rights
          reserved.
        </div>
        <script>
